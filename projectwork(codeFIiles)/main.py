...
label = tk.Label(root, text="Welcome to AI Virtual Mouse", fg="brown",font='TkDefaultFont 16 bold') 
...
start_button = tk.Button(root,text=" Track Mouse",fg="white", bg='black', font='Helvetica 12 bold italic ',command= runvirtualmouse , height="4", width="16",activebackground='lightblue') 
